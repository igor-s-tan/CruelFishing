...
import com.igorstan.cruelfishing.block.DemonicBrothBlock;
...
public class RegistryEventHandler {
    ...
    public static void onItemsRegistry(RegistryEvent.Register<Item> evt) {
        evt.getRegistry().registerAll(
                ...
                CruelItems.DEMONIC_BROTH_BUCKET,
...
//                CruelItems.SOUL_FISH
    ...
    public static void onFluidRegistry(RegistryEvent.Register<Fluid> evt) {
        ...
        evt.getRegistry().register(new DemonicBrothFluid.Flowing().setRegistryName(RegistryNames.DEMONIC_BROTH_FLOWING));
        evt.getRegistry().register(new DemonicBrothFluid.Source().setRegistryName(RegistryNames.DEMONIC_BROTH_FLUID));
    }
    ...
    public static void onBlocksRegistry(RegistryEvent.Register<Block> evt) {
        ...
        evt.getRegistry().registerAll(new DemonicBrothBlock().setRegistryName(RegistryNames.DEMONIC_BROTH_BLOCK));
    }
    ...
    public static final ResourceLocation FLESHRAT_DEATH_FLAG = new ResourceLocation(CruelFishingMod.MODID, RegistryNames.FLESHRAT_FISH + "_is_dead");
    @SubscribeEvent
    public void attachCapability(AttachCapabilitiesEvent<Entity> event) {
        if(event.getObject() instanceof PlayerEntity) {
            event.addCapability(FLESHRAT_AMOUNT, new StockMarketCapabilityProvider());
            event.addCapability(FLESHRAT_DEATH_FLAG, new StockMarketCapabilityProvider());
        }
    }
}
