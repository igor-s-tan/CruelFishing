...
public class FiberglassFishingRod extends FishingRodItem {

    public FiberglassFishingRod() {
        super(new Item.Properties().defaultMaxDamage(128).group(ItemGroup.TOOLS));
        this.setRegistryName(CruelFishingMod.MODID, "fiberglass_fishing_rod");
    }
    ...
    public ActionResult<ItemStack> onItemRightClick(World worldIn, PlayerEntity playerIn,
        ...
        if (playerIn.fishingBobber != null) {
            ...
            if (!worldIn.isRemote) {
                ...
                worldIn.addEntity(new FiberglassBobberEntity(playerIn, worldIn, j, k));
            }
            playerIn.swingArm(handIn);
